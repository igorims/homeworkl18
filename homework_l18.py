...
# указанного при определении инстанса (решение 1) или просто производить операции над двумя инстансами класса
...
class FractionNum:
    ...
    def __eq__(self, other):
        if {self.integer == self.decimal} == False:
...
# Решение 2. В объект вводятся 2 числа. По дробной части проходится проверка на положительное/отрицательное число, а
